 ...
 * #QueryPlanNew(Object...)} (Object...)}. It can be reused for custom load balancing policies; if
 * you plan to do so, study the source code of {@link DefaultLoadBalancingPolicy}.
 */
@ThreadSafe
public class QueryPlanNew extends AbstractCollection<Node> implements Queue<Node> {
   ...
   */
  public QueryPlanNew(@NonNull Object... nodes) {
    this.nodes = nodes;
  }
